...
set output 'rMean9_1000_1000.pdf'
set xlabel "P^{(N)}"
set ylabel "value density"
plot "rOpt_9_1000_1000.txt" using 3 smooth kdensity title ""
set output 'rMean9_1000_1000.pdf'
...
"rOpt_9_1000_1000.txt"  using 3 smooth kdensity title "opt" dt 6 lw 2 lc rgb "black", \
...
set output 'rDsel9_1000_1000.pdf'
set xtics 1,1,8
